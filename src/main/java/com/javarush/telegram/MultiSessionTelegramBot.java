...
public class MultiSessionTelegramBot extends TelegramLongPollingBot {
    ...
    public void showMainMenu(String... commands) {
        ...
        gmcs.setLanguageCode(LANGUAGE_CODE);
        gmcs.setScope(BotCommandScopeAllPrivateChats.builder().build());
        ...
        cmds.setLanguageCode(LANGUAGE_CODE);
        cmds.setScope(BotCommandScopeAllPrivateChats.builder().build());
    ...
    public void hideMainMenu() {
        ...
        dmds.setLanguageCode(LANGUAGE_CODE);
        dmds.setScope(BotCommandScopeAllPrivateChats.builder().build());
